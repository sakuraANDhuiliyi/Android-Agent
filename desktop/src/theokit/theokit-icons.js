/*
 * theokit-icons.js — Lucide-style inline SVG icon set for the TheoKit vanilla
 * component library. Migrated from theokit-ui (lucide-react usage).
 * Each icon is a factory: icons.terminal("size-3.5") -> <svg> element.
 */
(function (root) {
  "use strict";
  ...
  var PATHS = {
    ...
    "file-search": '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h4"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><circle cx="11.5" cy="14.5" r="2.5"/><path d="m13.3 16.3 3 3"/>',
    "file-text": '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M10 9H8"/><path d="M16 13H8"/><path d="M16 17H8"/>',
    filter: '<path d="M22 3H2l8 9.46V19l4 2v-8.54z"/>',
    folder: '<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>',
    "folder-open": '<path d="m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2"/>',
    git: '<circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/>',
    ...
    "wifi-off": '<path d="M2 2 22 22"/><path d="M8.5 16.5a5 5 0 0 1 7 0"/><path d="M2 8.82a15 15 0 0 1 4.17-2.65"/><path d="M10.66 5c4.01-.36 8.14.9 11.34 3.76"/><path d="M16.85 11.25a10 10 0 0 1 2.22 1.68"/><path d="M5 26a13 13 0 0 1 .55-4"/><path d="M12 20h.01"/>',
  ...
  Object.keys(PATHS).forEach(function (name) {
    ...
    var factory = make(name);
    icons[name] = factory;
    if (camel !== name) icons[camel] = factory;
  });

  root.Theokit = root.Theokit || {};
  root.Theokit.icons = icons;
